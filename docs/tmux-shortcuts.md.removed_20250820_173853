...
### 패널 크기 조절
- **`Alt+Ctrl+h`** - 왼쪽으로 5칸 축소
- **`Alt+Ctrl+j`** - 아래로 5칸 확장
- **`Alt+Ctrl+k`** - 위로 5칸 확장
- **`Alt+Ctrl+l`** - 오른쪽으로 5칸 확장

### 패널 관리
- **`Alt+x`** - 현재 패널 닫기
- **`Alt+z`** - 현재 패널 확대/축소 토글
- **`Alt+!`** - 현재 패널을 새 창으로 분리
- **`Alt+q`** - 패널 번호 표시
- **`Alt+V`** - 현재 패널을 이전 창에 수직으로(옆에) 붙이기
- **`Alt+S`** - 현재 패널을 이전 창에 수평으로(아래) 붙이기

### 레이아웃
- **`Alt+Space`** - 레이아웃 순환
- **`Alt+=`** - 모든 패널 동일 크기
- **`Alt+R`** - 패널 배치 시계방향 회전
- **`Alt+r`** - 패널 배치 반시계방향 회전
